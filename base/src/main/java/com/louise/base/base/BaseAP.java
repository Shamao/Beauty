    ...
    private void registerActivityListener() {
        registerActivityLifecycleCallbacks(new ActivityLifecycleCallbacks() {
            ...
            public void onActivityCreated(Activity activity, Bundle savedInstanceState) {
                ...
                ALogger.d(ConstTag.S_LIFE_CYCLE, activity.getClass().getSimpleName() + "-onActivityCreated" + activity.hashCode());
            }

            @Override
            public void onActivityStarted(Activity activity) {
                ALogger.d(ConstTag.S_LIFE_CYCLE, activity.getClass().getSimpleName() + "-onActivityStarted" + activity.hashCode());
            }
            ...
            public void onActivityPaused(Activity activity) {
                ALogger.d(ConstTag.S_LIFE_CYCLE, activity.getClass().getSimpleName() + "-onActivityDestroyed" + activity.hashCode());
            }
