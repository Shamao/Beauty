...
public class MenuBlockProvider extends ItemViewBinder<MolStringBean, MenuBlockViewHolder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull MenuBlockViewHolder holder, @NonNull MolStringBean item) {
