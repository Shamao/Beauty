...
public class UIToastUtils {
    ...
    private static UIToastUtils mInstance;
    // 动画时间
    ...
    public static UIToastUtils makeText(Context context, int resId, int HIDE_DELAY) {
        String mes = "";
        try {
    ...
    public void setText(CharSequence s) {
        ...
        TextView mTextView = (TextView) mView.findViewById(R.id.Message);
        if (mTextView == null) {
