...
public class AppManager {
	...
	private AppManager() { globalHandler = new Handler(Looper.getMainLooper());
	}
	...
	public SharedPreferences getSharePreferences() {
		config = this.currentActivity().getSharedPreferences("Config",
	...
	public void postDelayed(final DelayedAction action, final int duration) {
